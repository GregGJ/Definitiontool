import { EventHandler } from "./IEventDispatcher";
...
export class EventDispatcher {
    ...
    */
     ...
     */
    addEvent(key: string, caller: any, handler: EventHandler, priority: number = 0): void {
...
class EventInfo {
    ...
    constructor(key: string, target: any, handler: EventHandler) {
        this.key = key;
        this.target = target;
